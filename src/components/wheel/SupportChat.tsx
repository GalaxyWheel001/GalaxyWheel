...
function SupportChat({ isOpen, onClose }: SupportChatProps) {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      text: t('chat.welcomeMessage', { defaultValue: '👋 Hello! Welcome to Galaxy Wheel Support! How can I help you today?' }),
      isBot: true,
      timestamp: new Date()
    }
  ]);
  ...
  const handleSendMessage = () => {
    ...
    const botResponses = [
      ...
      t('chat.response6', { defaultValue: '⭐ Thank you for using Galaxy Wheel! Is there anything else I can help you with?' })
    ];
